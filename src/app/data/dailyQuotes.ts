export const dailyQuotes = [
  ...
  "In the sacred space of the present moment, all healing and transformation occur.",  "Trust that you are exactly where you need to be to receive the lessons your soul requires.",
  ...
  "Trust that your sensitivity is a superpower that allows you to heal and transform.",  "Your soul's wisdom is accessed through the doorway of deep listening.",
