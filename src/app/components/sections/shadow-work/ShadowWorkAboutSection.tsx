      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <img
            ...
            alt="Nadia Elmagrabi"
            className="w-32 h-32 rounded-full object-cover mx-auto mb-6 mystical-border divine-shadow"
          />
          <h2 className="text-3xl font-bold sacred-text text-forest mb-4">About Nadia Elmagrabi</h2>
          <p className="text-xl body-text text-earth/80 leading-relaxed">
