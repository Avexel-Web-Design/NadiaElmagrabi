      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            <Headphones className="w-12 h-12 text-gold mr-4" />
            <h1 className="text-4xl md:text-6xl font-bold sacred-text">
              Soul Awakening <span className="text-gold">Podcast</span>
            </h1>
          </div>
